...
dl_rpm_pkg $WORKDIR/rpms/ufs-utils <<< "nfs-utils-$VERSION"

# COPY 'install.sh' CONTENT
curl -Lo $WORKDIR/install.sh \
    https://raw.githubusercontent.com/haeramkeem/k8s-iac/main/offline-app-installer/nfs/rhel8/src/install.sh
